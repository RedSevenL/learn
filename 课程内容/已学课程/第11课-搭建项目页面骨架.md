...
| 仪表盘 | `/dashboard` | 查看账户、收入、支出、结余等摘要 |
...
集中保存首页卡片、仪表盘摘要、近期流水、场景卡片、导入流程和示例问题。
...
3. 假数据要集中管理，方便后续替换成 API 和数据库数据。

本课最重要的实践成果是：

> 搭建对话页、仪表盘、场景模拟页和 CSV 导入页，并让它们共享统一顶部导航和页面结构。
